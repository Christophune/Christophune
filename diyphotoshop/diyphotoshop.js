...
// preload() runs once, it may make you wait
  img = loadImage('https://christophune.github.io/photobrush.html');  // cat.jpg needs to be next to this .js file
...
function preload() {
// preload() runs once, it may make you wait
  img = loadImage('');  // cat.jpg needs to be next to this .js file
// you can link to an image on your github account
//  img = loadImage('https://dma-git.github.io/images/74.png');
}
